...
Use the Stellar CLI and CLI Skills to give your AI agents an agent-friendly wallet and native way to inspect, move, and manage assets on Stellar. After following the [Quickstart](./quickstart.md) to onboard your agent, you can use natural language to prompt your agent to use the Stellar CLI.
...
Beyond only using the Stellar CLI as a wallet, your agent can also use the full power of CLI to interact with, build, and deploy contracts. Humans can check out full CLI docs [here](https://developers.stellar.org/docs/tools/cli/stellar-cli).
...
- [Skills](skills.md) covers `stellar skill`, the built-in guide that teaches your agent the CLI's
  conventions.
...
- [Troubleshooting](reference/troubleshooting.md) for when something does not work.
